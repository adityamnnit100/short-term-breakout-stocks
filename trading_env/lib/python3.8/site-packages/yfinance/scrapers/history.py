...
class PriceHistory:
    ...
    def history(self, period=None, interval="1d",
        ...
        try:
            ...
            if data is None or (hasattr(data, 'text') and data.text and "Will be right back" in data.text):
            ...
            if 'currency' in dividends.columns:
                ...
                if f_currency_mismatch.any():
                    if not repair or price_currency == '':
                        ...
                        logger.warning(f"{self.ticker}: Currency mismatch in dividends. Keeping numeric values to avoid breaking technical analysis.")
                    else:
                        ...
                        if (dividends['currency'] != price_currency).any():
                            ...
                            logger.error(f"{self.ticker}: FX conversion failed for dividends. Numeric integrity maintained but values may be incorrect.")
